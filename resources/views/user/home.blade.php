                        ...
                        <div class="carousel-inner" role="listbox">
                            @foreach ($category as $index => $item)
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }} rounded">
                                    <img src="{{ url('storage/category/', $item->image) }}"
                                        class="img-fluid w-100 h-100 rounded" alt="{{ $item->name }}">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item">
                                                    ...
                                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        ...
                                                        <p>{!! implode(' ', array_slice(explode(' ', strip_tags($item->description)), 0, 10)) !!}...
                                                        </p>
                                                        <div class="d-flex justify-content-between flex-lg-wrap">
                                                            <p class="text-dark fs-5 fw-bold mb-0">Rp
                                                                {{ number_format($item->price, 0, ',', '.') }} / kg</p>
